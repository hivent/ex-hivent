defmodule Hivent.Consumer.Stages.ConsumerTest do
  ...
  setup do
    ...
    {:ok, producer} = Hivent.Consumer.Stages.Producer.start_link(consumer_name, :a_producer, 2)
    {:ok, consumer} = Hivent.Consumer.Stages.Consumer.start_link(producer, consumer_name)
